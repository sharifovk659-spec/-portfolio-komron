    ...
    <section id="home" className="relative flex min-h-screen items-center justify-center section-padding pt-24 sm:pt-32">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl text-center">
        ...
        <motion.div
          ...
          className="mx-auto mt-10 flex w-full max-w-sm flex-col gap-3 px-2 sm:max-w-none sm:flex-row sm:items-center sm:justify-center sm:gap-4"
        >
          <MagneticButton
          ...
          >
            <HiDownload size={18} className="shrink-0" />
